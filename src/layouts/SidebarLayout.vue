                            ...
                            <ul role="list" class="-mx-2 space-y-1">
                                <li v-for="item in navigation" :key="item.name">
                                    <button
                                        ...
                                        :class="[
                                            item.href === currentRoute ? 'bg-violet-700 text-white' : 'text-violet-200 hover:text-white hover:bg-violet-700',
                                            'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold w-full',
                                        ]"
                                    >
                                        <component
                                            :is="item.icon"
                                            :class="[item.href === currentRoute ? 'text-white' : 'text-violet-200 group-hover:text-white', 'h-6 w-6 shrink-0']"
                                            aria-hidden="true"
                                        />
                                        {{ item.name }}
                                    </button>
