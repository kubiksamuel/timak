                                                                ...
                                                                <div class="flex-1 p-4 pr-4 border-l border-gray-300">
                                                                    ...
                                                                    <div class="flex justify-between items-center flex-wrap">
                                                                        ...
                                                                        <button
                                                                            v-if="
                                                                                isOwner &&
                                                                                ((!milestone.completed && index === 0) || (!milestone.completed && index > 0 && milestones[index - 1].completed))
                                                                            "
                                                                            type="button"
...
const triggerCompleteMilestone = (show: boolean, milestoneId?: number) => {
    if (latestRepositoryVersionHash.value === "" || (milestoneId > 0 && milestones.value[milestoneId - 1].versionHash === latestRepositoryVersionHash.value)) {
