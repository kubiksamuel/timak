    ...
    <SidebarLayout>
        <div class="w-full h-full flex flex-col">
            ...
            <main class="flex-1">
                ...
                <div v-if="allRepositories.length > 0" class="mt-8 w-full px-8 pb-4 mx-auto hidden sm:block">
                ...
                <div v-else class="items-center justify-center h-full text-center flex flex-col">
                    <main>
