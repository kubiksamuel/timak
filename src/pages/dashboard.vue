<template>
    <div class="min-h-full">
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 bg-violet-200 lg:pt-5 lg:pb-4">
        ...
        <div class="flex flex-col lg:pl-64">
            ...
            <div class="sticky top-0 z-10 flex h-16 flex-shrink-0 border-b border-gray-200 bg-white lg:hidden">
                <button type="button" class="border-r border-gray-200 px-4 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-violet-500 lg:hidden" @click="sidebarOpen = true">
                ...
                <div class="flex flex-1 justify-between px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <Menu as="div" class="relative ml-3">
                            <div>
                                <MenuButton class="flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2">
            ...
            <main class="flex-1">
                ...
                <div v-if="allRepositories" class="mt-8 w-full px-8 pb-4 mx-auto hidden sm:block">
...
console.log("Repositories das: ", Object.values(allRepositories.value))
// const allRepositories = ref(repositoryStore.getRepositories)
// console.log("Repository in map: ", allRepositories)
// watch(repositories, () => {
//     return repositories.value.map((repository, index) => {
//         console.log("Repository in map: ", repository)
//         return {
//             id: index,
//             title: repository.name,
