                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input
                                ...
                                class="block w-full rounded-full outline-none border-0 px-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6"
                                placeholder="Address"
                            />
